...
// File created 30-Dec-2009 02:28:14 for Mozilla/5.0 (Windows; U; Windows NT 6.1; zh-CN; rv:1.9.1.5) Gecko/20091102 Firefox/3.5.5 QQDownload/1.7
var mxClient = {
    VERSION: '1.2.0.5',
...
var mxUtils = {
    ...
    eval: function(expr) {
        var result = null;
        if (expr.indexOf('function') >= 0 && (false || false || true || false || false)) {
            try {
...
if (window.location.hostname != 'mxgraph.com' && window.location.hostname != 'www.mxgraph.com') {
    ...
    if (i == len) {
        if ((new Date().getTime() / 1000) - 1262140094 > 15778463) {
            mxGraph = null;
        };
