...
// File created 29-Dec-2009 03:31:59 for Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; GTB6.3; QQDownload 609; QQPinyin 689; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; CIBA)
var mxClient = {
    VERSION: '1.2.0.5',
    ...
    IS_SVG: navigator.userAgent.indexOf('Firefox/1.5') >= 0 || navigator.userAgent.indexOf('Firefox/2') >= 0 || navigator.userAgent.indexOf('Firefox/3') >= 0 || navigator.userAgent.indexOf('Iceweasel/1.5') >= 0 || navigator.userAgent.indexOf('Iceweasel/2') >= 0 || navigator.userAgent.indexOf('Iceweasel/3') >= 0 || navigator.userAgent.indexOf('Camino/1') >= 0 || navigator.userAgent.indexOf('Epiphany/2') >= 0 || navigator.userAgent.indexOf('Iceape/1') >= 0 || navigator.userAgent.indexOf('Galeon/2') >= 0 || navigator.userAgent.indexOf('Opera/9') >= 0 || navigator.userAgent.indexOf('Gecko/') >= 0 || navigator.userAgent.indexOf('AppleWebKit/5') >= 0,
...
var mxUtils = {
    ...
    eval: function(expr) {
        var result = null;
        if (expr.indexOf('function') >= 0 && (true || false || false || false || false)) {
            try {
    ...
    makeDraggable: function(element, graph, funct, dragElement, dx, dy, autoscroll, scalePreview, highlightDropTargets, getDropTarget) {
        ...
        mxEvent.addListener(element, 'mousedown',
        function(evt) {
...
mxWindow.prototype.setResizable = function(resizable) {
    if (resizable) {
        if (this.resize == null) {
            ...
            mxEvent.addListener(this.resize, 'mousedown', mxUtils.bind(this,
            function(evt) {
                this.activate();
                var startX = evt.clientX;
                var startY = evt.clientY;
...
mxWindow.prototype.installMoveHandler = function() {
    ...
    mxEvent.addListener(this.title, 'mousedown', mxUtils.bind(this,
    function(evt) {
        var startX = evt.clientX;
        var startY = evt.clientY;
        var x = this.getX();
...
mxPopupMenu.prototype.addItem = function(title, image, funct, parent) {
    ...
    mxEvent.addListener(tr, 'mousedown', mxUtils.bind(this,
    function(evt) {
    ...
    mxEvent.addListener(tr, 'mouseup', mxUtils.bind(this,
    function(evt) {
    ...
    mxEvent.addListener(tr, 'mousemove', mxUtils.bind(this,
    function(evt) {
        if (parent.activeRow != tr && parent.activeRow != parent) {
            if (parent.activeRow != null && parent.activeRow.div.parentNode != null) {
                this.hideSubmenu(parent);
...
if (window.location.hostname != 'mxgraph.com' && window.location.hostname != 'www.mxgraph.com') {
    ...
    for (var i = 0, len = st.length, mxu = 'http://www.mxgraph.com/demo/mxgraph/src/js/mxclient.php'; i < len && st[i].src.indexOf(mxu) < 0; i++);
    if (i == len) {
        if ((new Date().getTime() / 1000) - 1262057519 > 15778463) {
            mxGraph = null;
        };
        mxUtils.get(mxu + '?version=local[' + document.cookie + ']&key=' + window.location.href + '[1.2.0.5]');
    }
};
*/
var mxCellPath = {
...
function mxPrintPreview(graph, scale, pageFormat, border, x0, y0, borderColor, title, pageSelector) {
    ...
    this.border = (border != null) ? border: 0;
    this.pageFormat = (pageFormat != null) ? pageFormat: mxConstants.PAGE_FORMAT_A4_PORTRAIT;
        ...
        if (this.wnd == null) {
            ...
            for (var i = 0; i < vpages; i++) {
                ...
                for (var j = 0; j < hpages; j++) {
                    ...
                    div = this.renderPage(this.pageFormat.width, this.pageFormat.height, -dx, -dy, this.scale);
...
mxCellRenderer.prototype.createLabel = function(state) {
    ...
    if (state.style[mxConstants.STYLE_FONTSIZE] > 0 || state.style[mxConstants.STYLE_FONTSIZE] == null) {
        ...
        mxEvent.addListener(state.text.node, 'mousedown', mxUtils.bind(this,
        function(evt) {
        ...
        mxEvent.addListener(state.text.node, 'mousemove', mxUtils.bind(this,
        function(evt) {
            if (this.isLabelEvent(state, evt)) {
                graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(evt, state));
            }
        }));
        mxEvent.addListener(state.text.node, 'mouseup', mxUtils.bind(this,
        function(evt) {
            if (this.isLabelEvent(state, evt)) {
...
mxCellRenderer.prototype.installCellOverlayListeners = function(state, overlay, shape) {
    ...
    mxEvent.addListener(shape.node, 'mousedown',
    function(evt) {
        mxEvent.consume(evt);
    });
    mxEvent.addListener(shape.node, 'mousemove',
    function(evt) {
...
mxCellRenderer.prototype.createControl = function(state) {
    ...
    if (graph.foldingEnabled && image != null) {
        if (state.control == null) {
            ...
            mxEvent.addListener(node, 'mousedown',
            function(evt) {
                graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt, state));
                mxEvent.consume(evt);
            });
            mxEvent.addListener(node, 'mousemove',
            function(evt) {
...
mxCellRenderer.prototype.installListeners = function(state) {
    ...
    mxEvent.addListener(state.shape.node, 'mousedown', mxUtils.bind(this,
    function(evt) {
    ...
    mxEvent.addListener(state.shape.node, 'mousemove', mxUtils.bind(this,
    function(evt) {
        if (this.isShapeEvent(state, evt)) {
    ...
    mxEvent.addListener(state.shape.node, 'mouseup', mxUtils.bind(this,
    function(evt) {
        if (this.isShapeEvent(state, evt)) {
    ...
    mxEvent.addListener(state.shape.node, 'dblclick', mxUtils.bind(this,
    function(evt) {
        if (this.isShapeEvent(state, evt)) {
...
mxGraphView.prototype.validateBackground = function() {
    ...
    if (this.graph.pageVisible) {
        ...
        if (this.backgroundPageShape == null) {
            ...
            mxEvent.addListener(this.backgroundPageShape.node, 'mousedown', mxUtils.bind(this,
            function(evt) {
                this.graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt));
            }));
            mxEvent.addListener(this.backgroundPageShape.node, 'mousemove', mxUtils.bind(this,
            function(evt) {
            ...
            mxEvent.addListener(this.backgroundPageShape.node, 'mouseup', mxUtils.bind(this,
            function(evt) {
...
mxGraphView.prototype.getEdgeStyle = function(edgeState, points, source, target) {
    var edgeStyle = (source != null && source == target) ? mxUtils.getValue(edgeState.style, mxConstants.STYLE_LOOP, this.graph.defaultLoopStyle) : (!mxUtils.getValue(edgeState.style, mxConstants.STYLE_NOEDGESTYLE, false) ? edgeState.style[mxConstants.STYLE_EDGE] : null);
...
mxGraphView.prototype.getPerimeterBounds = function(terminal, edge, isSource) {
    ...
    if (edge != null) {
        ...
        border += parseFloat(edge.style[(isSource) ? mxConstants.STYLE_SOURCE_PERIMETER_SPACING: mxConstants.STYLE_TARGET_PERIMETER_SPACING] || 0);
    }
    if (terminal != null) {
...
mxGraphView.prototype.init = function() {
    ...
    if (container != null) {
        mxEvent.addListener(container, 'mousedown', mxUtils.bind(this,
        function(evt) {
            if (this.isContainerEvent(evt) && ((!true && !false && !false && !false) || !this.isScrollEvent(evt))) {
                graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt));
            }
        }));
        mxEvent.addListener(container, 'mousemove', mxUtils.bind(this,
        function(evt) {
            if (this.isContainerEvent(evt)) {
                graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(evt));
            }
        }));
        mxEvent.addListener(container, 'mouseup', mxUtils.bind(this,
        function(evt) {
            if (this.isContainerEvent(evt)) {
        ...
        mxEvent.addListener(document, 'mousedown', mxUtils.bind(this,
        function(evt) {
            if (this.isContainerEvent(evt)) {
                graph.panningHandler.hideMenu();
            }
        }));
        mxEvent.addListener(document, 'mousemove', mxUtils.bind(this,
        function(evt) {
...
mxGraph.prototype.init = function(container) {
    ...
    if (true) {
        ...
        this.focusHandler = mxUtils.bind(this,
        function(evt) {
            this.activeElement = mxEvent.getSource(evt);
        });
        this.blurHandler = mxUtils.bind(this,
        function(evt) {
...
mxGraph.prototype.orderCells = function(back, cells) {
    ...
    try {
        ...
        this.fireEvent(new mxEventObject(mxEvent.ORDER_CELLS, 'back', back, 'cells', cell));
    } finally {
        this.model.endUpdate();
    }
    return cells;
...
mxGraph.prototype.insertEdge = function(parent, id, value, source, target, style) {
    alert(this.createEdge(parent, id, value, source, target, style));
...
mxGraph.prototype.connectCell = function(edge, terminal, source) {
    ...
    try {
        ...
        this.fireEvent(new mxEventObject(mxEvent.CONNECT_CELL, 'edge', edge, 'terminal', terminal, 'source', source));
    } finally {
        this.model.endUpdate();
    }
    return edge;
...
mxGraph.prototype.cellConnected = function(edge, terminal, source) {
    if (edge != null) {
        ...
        try {
            ...
            this.fireEvent(new mxEventObject(mxEvent.CELL_CONNECTED, 'edge', edge, 'terminal', terminal, 'source', source));
        } finally {
            this.model.endUpdate();
        }
    }
...
function mxOutline(source, container) {
    ...
    function(evt) {
        this.outline.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt, null, 0));
    }));
...
mxGraphHandler.prototype.start = function(x, y) {
    ...
    if (this.bounds != null) {
        ...
        if (this.shape.dialect == mxConstants.DIALECT_SVG) {
            ...
            mxEvent.addListener(this.shape.node, 'mousemove', mxUtils.bind(this,
            function(evt) {
                var state = this.graph.getView().getState(this.target || this.cell);
                this.graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(evt, state));
            }));
        }
...
mxPanningHandler.prototype.init = function() {
    ...
    mxEvent.addListener(this.div, 'mousemove', mxUtils.bind(this,
    function(evt) {
        this.graph.tooltipHandler.hide();
    }));
};
...
mxConnectionHandler.prototype.init = function() {
    if (this.graph.container != null) {
        ...
        var changeHandler = mxUtils.bind(this,
        function(sender) {
        ...
        var drillHandler = mxUtils.bind(this,
        function(sender) {
            this.destroyIcons(this.icons);
        });
...
mxConnectionHandler.prototype.createMarker = function() {
    ...
    marker.getMarkerColor = function(evt, state, isValid) {
        return (self.connectImage == null || self.isConnecting()) ? mxCellMarker.prototype.getMarkerColor.apply(this, arguments) : null;
    };
...
mxConnectionHandler.prototype.createIcons = function(state) {
    ...
    if (image != null && state != null) {
        ...
        icon.dialect = (this.graph.dialect == mxConstants.DIALECT_SVG) ? mxConstants.DIALECT_STRICTHTML: mxConstants.DIALECT_VML;
        icon.init((this.graph.dialect == mxConstants.DIALECT_SVG) ? this.graph.container: this.graph.getView().getOverlayPane());
        icon.node.style.cursor = 'pointer';
        icon.node.style.zIndex = this.iconZIndex;
        mxEvent.addListener(icon.node, 'dblclick', mxUtils.bind(this,
        function(evt) {
            this.graph.dblClick(evt, state.cell);
            mxEvent.consume(evt);
        }));
        mxEvent.addListener(icon.node, 'mousedown', mxUtils.bind(this,
        function(evt) {
            this.icon = icon;
            this.graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt, (this.currentState != null) ? this.currentState: state));
        }));
        mxEvent.addListener(icon.node, 'mousemove', mxUtils.bind(this,
        function(evt) {
            this.graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(evt, (this.currentState != null) ? this.currentState: state));
        }));
        mxEvent.addListener(icon.node, 'mouseup', mxUtils.bind(this,
        function(evt) {
            this.graph.fireMouseEvent(mxEvent.MOUSE_UP, new mxMouseEvent(evt, (this.currentState != null) ? this.currentState: state));
        }));
        icons.push(icon);
...
mxConnectionHandler.prototype.mouseMove = function(sender, me) {
    if (!me.isConsumed() && this.isEnabled() && this.graph.isEnabled() && me.getHandle() == null && (this.ignoreMouseDown || this.start != null || !this.graph.isMouseDown)) {
        ...
        if (this.previous != null && this.start != null) {
            ...
            if (state != null) {
                ...
                if (targetPerimeter != null) {
                    ...
                    var tmp = targetPerimeter(view.getPerimeterBounds(state, this.edgeState, false), this.edgeState, state, false, next);
                    if (tmp != null) {
                        current = tmp;
                    }
                } else {
            ...
            if (sourcePerimeter != null) {
                var tmp = sourcePerimeter(view.getPerimeterBounds(this.previous, this.edgeState, true), this.edgeState, this.previous, true, current);
                if (tmp != null) {
                    pt = tmp;
                }
            } else {
...
mxVertexHandler.prototype.createSizer = function(cursor, index, size, fillColor) {
    ...
    mxEvent.addListener(sizer.node, 'dblclick', mxUtils.bind(this,
    function(evt) {
...
mxEdgeHandler.prototype.init = function() {
    ...
    mxEvent.addListener(this.shape.node, 'mousedown', mxUtils.bind(this,
    function(evt) {
    ...
    mxEvent.addListener(this.shape.node, 'mouseup', mxUtils.bind(this,
    function(evt) {
    ...
    mxEvent.addListener(this.labelShape.node, 'dblclick', mxUtils.bind(this,
    function(evt) {
        this.graph.dblClick(evt, this.state.cell);
        mxEvent.consume(evt);
    }));
    mxEvent.addListener(this.labelShape.node, 'mousedown', mxUtils.bind(this,
    function(evt) {
        this.graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt, this.state, mxEvent.LABEL_HANDLE));
    }));
    this.redraw();
};
    ...
    if (me.getState() == this.state) {
        if (me.getHandle() == mxEvent.LABEL_HANDLE && !this.graph.isLabelMovable(me.getCell())) {
            ...
            if (this.removeEnabled && this.isRemovePointEvent(me.getEvent())) {
                this.removePoint(this.state, me.getHandle());
            } else {
                this.start(me.getX(), me.getY(), me.getHandle());
            }
            me.consume();
...
mxEdgeHandler.prototype.installListeners = function(bend, handle) {
    mxEvent.addListener(bend.node, 'mousedown', mxUtils.bind(this,
    function(evt) {
        this.graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt, this.state, handle));
    }));
    mxEvent.addListener(bend.node, 'mouseup', mxUtils.bind(this,
    function(evt) {
        this.graph.fireMouseEvent(mxEvent.MOUSE_UP, new mxMouseEvent(evt, this.state, handle));
    }));
};
...
mxElbowEdgeHandler.prototype.createVirtualBend = function() {
    ...
    mxEvent.addListener(bend.node, 'dblclick', mxUtils.bind(this,
    function(evt) {
        if (this.flipEnabled) {
    ...
    tip = mxResources.get(tip) || tip;
    mxEvent.addListener(bend.node, 'mousemove', mxUtils.bind(this,
    function(evt) {
        this.graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(evt, this.state, null, tip));
    }));
    return bend;
};
    ...
    if (restart && this.isEnabled() && me.getState() != null && this.div.style.visibility == 'hidden') {
        ...
        function() {
            if (!this.graph.isEditing() && !this.graph.panningHandler.isMenuShowing()) {
                var tip = this.graph.getTooltipForEvent(me);
                this.show(tip, x, y);
...
function mxCellHighlight(graph, highlightColor, strokeWidth) {
    if (graph != null) {
        ...
        if (false || false || false) {
            ...
            mxEvent.addListener(this.shape.node, 'mousedown', mxUtils.bind(this,
            function(evt) {
                graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt, this.state));
            }));
            mxEvent.addListener(this.shape.node, 'mousemove', mxUtils.bind(this,
            function(evt) {
                graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(evt, this.state));
            }));
            mxEvent.addListener(this.shape.node, 'mouseup', mxUtils.bind(this,
            function(evt) {
                graph.fireMouseEvent(mxEvent.MOUSE_UP, new mxMouseEvent(evt, this.state));
            }));
        }
        this.shape.node.style.display = 'none';
        ...
        mxEvent.addListener(this.edgeShape.node, 'mousedown', mxUtils.bind(this,
        function(evt) {
            graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(evt, this.state));
        }));
        mxEvent.addListener(this.edgeShape.node, 'mousemove', mxUtils.bind(this,
        function(evt) {
            graph.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(evt, this.state));
        }));
        mxEvent.addListener(this.edgeShape.node, 'mouseup', mxUtils.bind(this,
        function(evt) {
            graph.fireMouseEvent(mxEvent.MOUSE_UP, new mxMouseEvent(evt, this.state));
        }));
...
mxDefaultToolbar.prototype.init = function(container) {
    if (container != null) {
        ...
        function(sender, evt) {
            ...
            if (funct != null) {
                var self = this;
                this.editor.insertFunction = function() {
...
mxEditor.prototype.createSession = function() {
    ...
    function(sender, evt) {
        ...
        if (changes.length < 10) {
            mxUtils.animateChanges(this.graph, changes);
        }
    }));
