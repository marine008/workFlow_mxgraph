...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	this.addPalette('general', mxResources.get('general'), expand || true, mxUtils.bind(this, function(content)
	{
	    ...
	    content.appendChild(this.createEdgeTemplate('edgeStyle=none;endArrow=none;', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('edgeStyle=none', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('edgeStyle=elbowEdgeStyle;elbow=horizontal', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('edgeStyle=elbowEdgeStyle;elbow=vertical', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('edgeStyle=entityRelationEdgeStyle', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('edgeStyle=segmentEdgeStyle', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('edgeStyle=orthogonalEdgeStyle', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('shape=link', 100, 100, node));
	    content.appendChild(this.createEdgeTemplate('arrow', 100, 100, node));
	}));
};
